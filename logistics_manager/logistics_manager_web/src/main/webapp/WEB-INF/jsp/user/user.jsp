...
<body>
    ...
    <table class="tablelist">
        ...
        <c:forEach items="${pageModel.list }" var="user">
	        ...
	        <td>${user.email }</td>
	        <td>${user.phone }</td>
	        <td><a href="/user/goAddOrUpdate?userId=${user.userId }" class="tablelink">修改</a>     
	        	<a href="javascript:void(0)" onclick="goDelete(${user.userId })" class="tablelink"> 删除</a>
	        </td>
	        </tr> 
      	 </c:forEach>
        </tbody>
