        ...
        <c:forEach items="${list }" var="bd">
        	<c:if test="${empty bd.parentId }">
		        ...
		        <tr>
			        ...
			        <td>${bd.parentId }</td>
			        <td>${bd.baseDesc }</td>
			        <td><a href="/basic/goAddOrUpdate?baseId=${bd.baseId }" class="tablelink">修改</a>     
		        ...
		        <c:forEach items="${list }" var="small">
		        	<c:if test="${small.parentId eq bd.baseId }">
		        		<tr>
					        ...
					        <td><a href="/basic/goAddOrUpdate?baseId=${small.baseId }" class="tablelink">修改</a>     
